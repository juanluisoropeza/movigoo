...
<body>
  ...
  <main class="mcont">
    <section id="contacto_demo">
      <div class="container">
        <form id="contactForm" novalidate>
          <div class="row">
            <div class="col-lg-8 left_content">
              <h1>
              Solicita una demo acorde a tu negocio
              </h1>
              <p>
            ...
            <div class="col-lg-4 right_content">
              ...
              <div class="row">
                ...
                <div class="control-group col-xs-12 col-md-6 col-lg-12">
                  <div class="form-group floating-label-form-group controls">
                    <input type="email" class="form-control" placeholder="Correo empresa *" id="txt_correo_empresa" required data-validation-required-message="Por favor, Ingrese el <b>correo de la empresa</b>.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="control-group col-xs-12 col-md-6 col-lg-12">
                  <div class="form-group floating-label-form-group controls">
                    <input type="text" class="form-control" placeholder="Cargo *" id="txt_cargo" required data-validation-required-message="Por favor, Ingrese el <b>cargo</b>.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
                <div class="control-group col-xs-12 col-md-6 col-lg-12">
                  <div class="form-group floating-label-form-group controls">
                    <input type="text" class="form-control" placeholder="Empresa *" id="txt_empresa" required data-validation-required-message="Por favor, Ingrese la <b>empresa</b>.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="control-group col-xs-12 col-md-6 col-lg-12">
                  <div class="form-group floating-label-form-group controls">
                    <input type="number" class="form-control" placeholder="Número de contacto *" id="txt_numero" required data-validation-required-message="Por favor, <b>Ingrese el número de contacto</b>.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
                <div class="control-group col-xs-12 col-md-6 col-lg-12">
              ...
              <div class="row">
                <div class="col-12 boton">
                  <div id="success"></div>
                  <input type="hidden" name="formulario" id="formulario" value="formContactoDemo">
